...
Меня привлекло тестирование тем, что здесь нужно не просто находить ошибки, а разбираться в логике системы и понимать, почему она ведёт себя именно так. При обнаружении бага мне важно определить условия его возникновения, локализовать проблему и разобраться в её причине.
